import 'package:derwise_app/pages/Chat_Screen/components/chat_bubble.dart';
import 'package:derwise_app/pages/Chat_Screen/components/chat_detail_page_appbar.dart';
import 'package:derwise_app/pages/Chat_Screen/models/chat_message.dart';
import 'package:derwise_app/pages/Chat_Screen/models/send_menu_items.dart';
import 'package:derwise_app/pages/Chat_Screen/models/chat_message.dart';
import 'package:derwise_app/pages/Chat_Screen/models/send_menu_items.dart';
...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  List<SendMenuItems> menuItems = [
    SendMenuItems(
        text: "Photos & Videos", icons: Icons.image, color: Colors.blue),
    SendMenuItems(
        text: "Document", icons: Icons.insert_drive_file, color: Colors.blue),
    SendMenuItems(text: "Audio", icons: Icons.music_note, color: Colors.blue),
    SendMenuItems(
        text: "Location", icons: Icons.location_on, color: Colors.blue),
